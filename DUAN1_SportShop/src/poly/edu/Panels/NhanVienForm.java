...
//        initWebcam();
    ...
    public void emailSend() {
        try {
            ...
            final String pass = "rsqw ftvz rwpm wjgn";
    ...
    public void loadData() {
        ...
        dm.setRowCount(0);
        for (NhanVien n : lst) {
            dm.addRow(new Object[]{n.getID(), n.getMaNV(), n.getCCCD(), n.getTen(),
                n.getTuoi(), n.getEmail(), n.getSDT(), n.getDiaChi(), n.vaitro(n.getVaiTro())});
        }
    }
    ...
    public NhanVien model() {
        ...
        NhanVien nv = new NhanVien(id, vaitro, txtCCCD.getText(), txtTen.getText(),
                ...
                DC, txtMK.getText(), txtMaNV.getText(), strDate);
        return nv;
    }
    ...
    public void detail(int index) {
        ...
        txtDCCT3.setText(tblNV1.getValueAt(index, 7).toString());
    }
    ...
    public boolean vali() {
        if (txtMaNV.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Ma NV ko duoc bo trong");
            return false;
        }
        if (txtMK.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Mat khau ko duoc bo trong");
            return false;
        }
        if (txtCCCD.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Ma CCCD ko duoc bo trong");
            return false;
        }
        if (txtTen.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Ten ko duoc bo trong");
            return false;
        }
        if (txtTuoi.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Tuoi ko duoc bo trong");
            return false;
        }
        if (txtEmail.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Email ko duoc bo trong");
            return false;
        }
        if (txtSDT.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "SDT ko duoc bo trong");
            return false;
        }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 60, -1, -1));
        ...
        jPanel2.add(txtTuoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 80, 290, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setText("Số điện thoại");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, -1, -1));

        buttonGroup1.add(rdoAD);
        rdoAD.setText("Admin");
        jPanel2.add(rdoAD, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, -1, -1));

        buttonGroup1.add(rdoNV);
        rdoNV.setText("Nhân viên");
        jPanel2.add(rdoNV, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, -1, -1));
        ...
        jPanel2.add(txtMK, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 270, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel13.setText("Mã NV");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, -1));
        jPanel2.add(txtTen, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 270, -1));
        jPanel2.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 50, 290, -1));
        jPanel2.add(txtSDT, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 110, 290, -1));
        ...
        jPanel2.add(txtCCCD, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 270, -1));
        ...
        jPanel4.add(btnQRCODE, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 250, 170));
        ...
        tblNV1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã NV", "Số CCCD", "Tên NV", "Tuổi", "Email", "SDT", "Địa chỉ", "Vai trò"
            }
        ));
    ...
    private void btnDelteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelteActionPerformed
        ...
        String id = String.valueOf(tblNV1.getValueAt(slid, 0).toString());
        int i = JOptionPane.showConfirmDialog(this, "Xoa nhan vien?", "Xoa", JOptionPane.YES_OPTION);
    ...
    private void btnQRCODEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQRCODEActionPerformed
        ...
        jPanel4.add(panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 300, 190));
