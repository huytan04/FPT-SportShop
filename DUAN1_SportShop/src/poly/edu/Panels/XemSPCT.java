...
public class XemSPCT extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        maQR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Qr Code.png"))); // NOI18N
    ...
    private void btnTaoQRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaoQRActionPerformed
        ...
        try {                
            XemSPCT xem = new XemSPCT(jFrame1, true);
                    ByteArrayOutputStream out = net.glxn.qrgen.QRCode.from(xem.getContentPane().toString()).to(ImageType.PNG).stream();
