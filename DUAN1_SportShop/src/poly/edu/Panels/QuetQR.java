...
public class QuetQR extends javax.swing.JDialog implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 319, 252));
        jPanel1.add(txtMa, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 310, -1));
...
//                new XemSPCT(jFrame1, true);
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        XemSPCT xem = new XemSPCT(jFrame1, true);
                        xem.setVisible(true); // Mở JDialog
                    }
                });
